...
public class DepartmentsTest {
    ...
    @Test
    public void whenMissedManyAndSortDescAll() {
        List<String> input = Arrays.asList("k1/sk1/ssk1", "k2/sk1/ssk1", "k1/sk2/ssk2", "k1/sk2/ssk1",
                "k1/sk1/ssk2", "k2/sk2/ssk1", "k2/sk2/ssk2", "k2/sk1/ssk2");
        List<String> expect = List.of("k2", "k2/sk1", "k2/sk1/ssk1", "k2/sk1/ssk2", "k2/sk2",
                "k2/sk2/ssk1", "k2/sk2/ssk2", "k1", "k1/sk1", "k1/sk1/ssk1", "k1/sk1/ssk2",
                "k1/sk2", "k1/sk2/ssk1", "k1/sk2/ssk2");
        List<String> result = Departments.fillGaps(input);
        Departments.sortDesc(result);
        assertThat(result, is(expect));
    }
